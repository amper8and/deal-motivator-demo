const { Card, CardContent, CardHeader, CardTitle, CardDescription, Button, Input, Textarea, Badge, Tabs, TabsContent, TabsList, TabsTrigger, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Separator, Progress, Switch, Alert, AlertDescription, AlertTitle, CheckCircle2, CircleAlert, Clock, FileText, Mail, Play, Pause, RefreshCw, ShieldCheck, Sparkles, Upload, Wand2, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, ListOrdered } = window;
...
function DealMotivationDemoApp() {
...
const root = ReactDOM.createRoot(document.getElementById('root')); root.render(React.createElement(DealMotivationDemoApp));
